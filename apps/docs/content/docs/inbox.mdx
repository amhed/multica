...
On web and desktop, child notifications appear under their parent issue. Groups
start expanded and move up when any matching notification in the group is newer.
Collapse a group to keep its child-update and unread counts visible while hiding
its descendants.
